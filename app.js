...
if(localStorage.getItem('storedItem')==null){
    ...
    signup.style='display:block;position: absolute;right:10%;cursor:pointer;background-color: green;border:3px solid 777;border-radius: 40px;padding:20px;color:white;cursor: pointer;';
}
