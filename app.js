...
document.querySelector('#showmsg').addEventListener('click',async()=>{
   ...
   document.querySelector('#listmsg').style='display:flex;flex-wrap:wrap;height:100vh;width:100%;justify-content:center;align-content:center;background-color:azure;';
   document.querySelector('#msgsec').style='display:none;';
